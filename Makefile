...
ML= misc_functions.ml http_helpers.ml yojson_helpers.ml gmap.ml gset.ml coll.ml qc_environment.ml qasmsyntax.ml qc_symbolic.ml qasmlex.ml qasmparser.ml qasmpp.ml qasmdag0.ml qasm_passes.ml qc_layout.ml qobj_types.ml qobj_compile.ml qc_execute.ml qrpc_types.ml qrpc_api.ml
MLI= gmap.mli gset.mli

SRC=http_helpers.ml yojson_helpers.ml qc_environment.ml qasmlex.ml qasmsyntax.ml qc_symbolic.ml coll.ml gmap.ml gset.ml qc_tests.ml large_tests.ml qobj_types.ml qobj_compile.ml qc_execute.ml qrpc_types.ml qrpc_api.ml
