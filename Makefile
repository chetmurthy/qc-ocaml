...
ML= misc_functions.ml yojson_functions.ml gmap.ml gset.ml coll.ml qc_environment.ml qasmsyntax.ml qc_symbolic.ml qasmlex.ml qasmparser.ml qasmpp.ml qasmdag0.ml qasm_passes.ml qc_layout.ml qobj_types.ml qc_emitjson.ml qrpc_types.ml qrpc_api.ml
MLI= gmap.mli gset.mli

SRC=yojson_functions.ml qc_environment.ml qasmlex.ml qasmsyntax.ml qc_symbolic.ml coll.ml gmap.ml gset.ml qc_tests.ml large_tests.ml qobj_types.ml qc_emitjson.ml qrpc_types.ml qrpc_api.ml
