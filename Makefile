...
ML= misc_functions.ml gmap.ml gset.ml coll.ml qc_environment.ml qasmsyntax.ml qasmlex.ml qasmparser.ml qasmpp.ml qasmdag0.ml qasm_passes.ml qc_layout.ml qc_emitjson.ml qrpc_types.ml qrpc_api.ml
MLI= gmap.mli gset.mli

SRC=qc_environment.ml qasmlex.ml qasmsyntax.ml coll.ml gmap.ml gset.ml qc_tests.ml large_tests.ml qc_emitjson.ml qrpc_types.ml qrpc_api.ml
